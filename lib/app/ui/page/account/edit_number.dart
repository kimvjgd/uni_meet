      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Spacer(flex: 1,),
            Text("휴대폰 번호를 입력해주세요",style: TextStyle(color: CupertinoColors.systemGrey.withOpacity(0.7),fontSize: 20),),
            Row(
              children: [
                ...
                Expanded(
                  child: Form(
                    ...
                    child: TextFormField(
                      ...
                      validator:(number){
                        if(number!.trim().length == 8) return null;
                        else return '번호를 다시 한 번 확인해주세요!';
                      },
